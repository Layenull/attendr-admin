...
const Cards = ({ cdImage, text, route, onClick }) => {
    ...
    return (
        // <div className='max-w-sm rounded-3xl border-2 overflow-hidden shadow-lg flex justify-center flex-col p-50 cursor-pointer hover:scale-105 transition-transform'
